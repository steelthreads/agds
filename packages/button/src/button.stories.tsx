...
export const Block = () => (
  <>
    ...
    <hr/>
    <Button block variant={'secondary'}>Secondary + Block</Button>
    <hr/>
...
export const Dark = () => (
  <>
    ...
    <hr/>
    <Button colorScheme={'dark'} variant={'secondary'}>Secondary + Dark</Button>
    <hr/>
    <Button colorScheme={'dark'} variant={'tertiary'}>Tertiary + Dark</Button>
  </>
);
